...
int main()
{
    ...
    */
    /* Khai báo các biến, cổng, bộ đệm, cấu trúc dữ liệu lưu địa chỉ của socket */ 
    int client, server;
    int portNum = 1500;
    bool isExit = false;
    int bufsize = 1024;
    ...
    /* Tạo socket với hàm socket (AF_INET, SOCK_STREAM, 0) các tham số trong đó theo thứ tự là họ giao thức, kiểu socket, kiểu giao thức */
    if (client < 0) 
    {
    ...
    */
    ...
    listen(client, 1);
    /*•	Chỉ định socket lắng nghe kết nối listen (client,1) trong đó client là mô tả socket vừa tạo, 1là số lượng 1 tối đa các kết nối đang chờ*/
    ...
    */
    ...
    server = accept(client,(struct sockaddr *)&server_addr,&size);
     /*	Chờ/chấp nhận kết nối accept (client,(struct sockaddr *)&server_addr,&size) lần lượt có các tham số là mô tả socket vừa tạo,
     con trỏ tới cấu trúc địa chỉ socket của tiến trình kết nối đến, độ lớn cấu trúc địa chỉ */
